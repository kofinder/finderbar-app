...
import com.finderbar.jovian.fragments.discuss.AnswerCommentFragment
import com.finderbar.jovian.fragments.discuss.AnswerDownVoteFragment
import com.finderbar.jovian.fragments.discuss.AnswerFavoriteFragment
import com.finderbar.jovian.fragments.discuss.AnswerUpVoteFragment
import java.util.logging.Logger

class AnswerActionActivity : AppCompatActivity() {
    companion object {
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        adapter.addFrag(AnswerCommentFragment(), "")
        adapter.addFrag(AnswerUpVoteFragment(), "")
        adapter.addFrag(AnswerDownVoteFragment(), "")
        adapter.addFrag(AnswerFavoriteFragment(), "")
