 ...
 */
class UserDataSourceFactory(private val apolloClient: ApolloClient): DataSource.Factory<Int, User>() {
    private val lastDataSource = MutableLiveData<UserDataSource>()
    ...
    override fun create(): DataSource<Int, User> {
        return UserDataSource(apolloClient, query).also {
