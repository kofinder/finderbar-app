...
class AnswerUpVoteDataSourceFactory(private val apolloClient: ApolloClient): DataSource.Factory<Int, User>() {

    private val lastDataSource = MutableLiveData<AnswerUpVoteDataSource>()
    ...
    override fun create(): DataSource<Int, User> {
        return AnswerUpVoteDataSource(apolloClient, answerId).also { lastDataSource.postValue(it) }
    }
