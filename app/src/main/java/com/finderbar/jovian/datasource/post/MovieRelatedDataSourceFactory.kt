...
class MovieRelatedDataSourceFactory (private val apolloClient: ApolloClient): DataSource.Factory<Int, Movie>() {

    private val lastDataSource = MutableLiveData<MovieRelatedDataSource>()
    ...
    override fun create(): DataSource<Int, Movie> {
        return MovieRelatedDataSource(apolloClient, userId).also { lastDataSource.postValue(it) }
    }
