...
class PostDataSourceFactory(private val apolloClient: ApolloClient): DataSource.Factory<Int, Post>() {

    private val lastDataSource = MutableLiveData<PostDataSource>()
    ...
    override fun create(): DataSource<Int, Post> {
        return PostDataSource(apolloClient, word).also { lastDataSource.postValue(it) }
    }
