...
class QuestionDownVoteDataSourceFactory(private val apolloClient: ApolloClient): DataSource.Factory<Int, User>() {

    private val lastDataSource = MutableLiveData<QuestionDownVoteDataSource>()
    ...
    var discussType: DiscussType  = DiscussType.QUESTION

    override fun create(): DataSource<Int, User> {
        return QuestionDownVoteDataSource(apolloClient, discussId).also { lastDataSource.postValue(it) }
    }
