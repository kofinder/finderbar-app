 ...
 */
class TagDataSourceFactory(private val apolloClient: ApolloClient): DataSource.Factory<Int, Tags>() {
    private val lastDataSource = MutableLiveData<TagDataSource>()
    ...
    override fun create(): DataSource<Int, Tags> {
        return TagDataSource(apolloClient, query).also {
