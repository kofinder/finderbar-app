...
import com.finderbar.jovian.utilities.AppConstants.ARG_KEY_ANSWER_ID
...
class AnswerEditDialogFragment : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            answerId = bundle.getString(ARG_KEY_ANSWER_ID)
    ...
    override fun onCreateView(inflater: LayoutInflater, parent: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view =  inflater.inflate(R.layout.fragment_dialog_answer_edit, parent, false)
        ...
        saveButton.setOnClickListener{
            progress.show()
            askAnswerVm?.editAnswer(answerId!!, questionId!!, etPrimaryEditor.text.toString())
        }
    ...
    companion object {
        const val TAG = "AnswerEditDialogFragment"
        fun newInstance(questionId: String, discuss: Discuss): AnswerEditDialogFragment {
            val fragment = AnswerEditDialogFragment()
            val args = Bundle()
            args.putString(ARG_KEY_QUESTION_ID, questionId)
            args.putString(ARG_KEY_ANSWER_ID, discuss._id)
            args.putString(ARG_KEY_ANSWER_BODY, discuss.body)
