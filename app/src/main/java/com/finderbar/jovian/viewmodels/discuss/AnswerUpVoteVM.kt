...
import com.finderbar.jovian.datasource.discuss.AnswerUpVoteDataSourceFactory
import com.finderbar.jovian.utilities.NetworkState

class AnswerUpVoteVM: ViewModel() {

    private var dataSourceFactory = run { AnswerUpVoteDataSourceFactory(apolloClient) }
