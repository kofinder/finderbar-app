...
import com.finderbar.jovian.datasource.user.UserAnswerDataSourceFactory

class UserProfileAnswerVM: ViewModel() {

    private var dataSourceFactory = run { UserAnswerDataSourceFactory(apolloClient) }
