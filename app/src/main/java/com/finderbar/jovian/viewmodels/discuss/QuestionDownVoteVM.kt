...
import com.finderbar.jovian.datasource.discuss.QuestionDownVoteDataSourceFactory
import com.finderbar.jovian.utilities.NetworkState

class QuestionDownVoteVM: ViewModel() {

    private var dataSourceFactory = run { QuestionDownVoteDataSourceFactory(apolloClient) }
